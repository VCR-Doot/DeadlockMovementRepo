    ...
    public class Roll: BaseState
    {
        ...
        public override void OnEnter()
        {
            ...
            previousPosition = transform.position - b;
                ...
                PlayAnimation("FullBody, Override", "Slide", "Utility.playbackRate", duration);
                Util.PlaySound(dodgeSoundString, gameObject);
                if (NetworkServer.active)
                {
                    characterBody.AddTimedBuff(LegacyResourcesAPI.Load<BuffDef>("BuffDefs/HiddenInvincibility"), 0.75f * duration);
                } 
        }
